...
Source0  : https://github.com/pocoproject/poco/archive/refs/tags/poco-1.12.4-release.tar.gz
...
%prep
%setup -q -n poco-poco-1.12.4-release
cd %{_builddir}/poco-poco-1.12.4-release
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681401841
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/poco-poco-%{version}-release/Foundation/wcelibcex-1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/poco/1f6f55328bcc8c457a005c3e1264106223af2c23 || :
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libPocoActiveRecord.so.94
/usr/lib64/libPocoCrypto.so.94
/usr/lib64/libPocoData.so.94
/usr/lib64/libPocoDataMySQL.so.94
/usr/lib64/libPocoDataODBC.so.94
/usr/lib64/libPocoDataPostgreSQL.so.94
/usr/lib64/libPocoDataSQLite.so.94
/usr/lib64/libPocoEncodings.so.94
/usr/lib64/libPocoFoundation.so.94
/usr/lib64/libPocoJSON.so.94
/usr/lib64/libPocoJWT.so.94
/usr/lib64/libPocoMongoDB.so.94
/usr/lib64/libPocoNet.so.94
/usr/lib64/libPocoNetSSL.so.94
/usr/lib64/libPocoPrometheus.so.94
/usr/lib64/libPocoRedis.so.94
/usr/lib64/libPocoUtil.so.94
/usr/lib64/libPocoXML.so.94
/usr/lib64/libPocoZip.so.94

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/poco/1f6f55328bcc8c457a005c3e1264106223af2c23
